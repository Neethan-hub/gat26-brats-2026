...
Code availability: \ownerinput{public source-code URL --- a short paper must report a source-code
link; the GAT-26 repository is currently PRIVATE and no public release has yet occurred}.

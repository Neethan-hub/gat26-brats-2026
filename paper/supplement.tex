...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: $\Pr(\Delta U_\tau>0)=1.0$, 95\% percentile interval $[+0.001284,+0.004548]$.
Per-fold $\Delta U_\tau$: fold 0 $+0.001235$, fold 1 $+0.003874$, fold 2 $+0.002497$.
...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: \emph{not present in the committed record for this tolerance, and not computed after the fact.}
...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: $\Pr(\Delta U_\tau>0)=0.7342$, 95\% percentile interval $[-0.002531,+0.002633]$.
Per-fold $\Delta U_\tau$: fold 3 $+0.002323$, fold 4 $-0.000883$.
...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: $\Pr(\Delta U_\tau>0)=0.9609$, 95\% percentile interval $[-0.000313,+0.004167]$.
Per-fold $\Delta U_\tau$: fold 3 $+0.003882$, fold 4 $+0.001055$.
...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: $\Pr(\Delta U_\tau>0)=0.9875$, 95\% percentile interval $[+0.000256,+0.003361]$.
Per-fold $\Delta U_\tau$: fold 0 $+0.001235$, fold 1 $+0.003874$, fold 2 $+0.002497$, fold 3 $+0.002323$, fold 4 $-0.000883$.
...
\end{tabular}
\end{table}
\noindent Paired subject-level bootstrap: $\Pr(\Delta U_\tau>0)=1.0$, 95\% percentile interval $[+0.002199,+0.004709]$.
Per-fold $\Delta U_\tau$: fold 0 $+0.002973$, fold 1 $+0.004721$, fold 2 $+0.004818$, fold 3 $+0.003882$, fold 4 $+0.001055$.

...
\midrule
Development: true positives & $3990$ & $4000$ \\
Development: false positives & $1243$ & $1087$ \\
Development: false negatives & $4103$ & $4116$ \\
Holdout: true positives & $2698$ & $2640$ \\
Holdout: false positives & $864$ & $781$ \\
Holdout: false negatives & $2726$ & $2764$ \\
Holdout: reference components & $5445$ & $5445$ \\
Holdout: miss rate & $0.500643$ & $0.507622$ \\
\bottomrule
\end{tabular}
\end{table}
